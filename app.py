...
with st.expander("ℹ️ How the app works", expanded=True):
    ...
    <div style="background-color: #f0f2f6; padding: 20px; border-radius: 10px;">
      ...
      <ul>
        <li><b>Target SERP Position:</b> The 'Target SERP Position' is an **aspirational average** you aim for among your *most important and achievable keywords*, rather than a literal expectation for every single query. In reality, not all keywords will reach the same position due to varying competition and relevance.</li>
